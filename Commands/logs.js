      ...
      const selectMenuRow = new ActionRowBuilder().addComponents(
        new StringSelectMenuBuilder()
          ...
          .addOptions([
            ...
            { label: "Warning Logs", value: "warnings", default: currentCategory === "warnings" },
            { label: "Automod Logs", value: "automod", default: currentCategory === "automod" },
            { label: "Moderation Action Logs", value: "moderation_actions", default: currentCategory === "moderation_actions" },
            { label: "System Health Logs", value: "system", default: currentCategory === "system" },
